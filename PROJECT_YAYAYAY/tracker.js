...
function Question_3()
{
    ...
    let check = age%1;
    if(age == "" || check != 0 || age < 14 || age > 100)
    {
        alert("Type in a correct input (Can only accept between the ages of 14 and 100)"); 
    ...
    else
    {
        ...
        document.getElementById("answer_4_Feet").focus();
    }
}
function Question_4()
{
    var Feet = document.getElementById("answer_4_Feet").value; 
    var inches = document.getElementById("answer_4_Inches").value;
    let check1 = Feet/1; 
    let check1_other = parseInt(Feet)/1;
    let check2 = inches/1; 
    let check2_other = parseInt(inches)/1;

    if(Feet == "" || inches == "" ||inches > 12 || check1 != check1_other || check2 != check2_other || Feet < 0 || inches < 0)
    {
        alert("Type in a correct input(MUST BE A NUMBER AND INCHES MUST BE LESS THAN 12"); 
        document.getElementById("answer_4_Feet").value = ""; 
        document.getElementById("answer_4_Inches").value = ""; 
        document.getElementById("answer_4_Feet").focus(); 
    }
    else
    {
        height = (Feet * 12) + parseFloat(inches);
        if(height > 96 || height < 24)
        {
            alert("Type in a correct input(Height must be between 2 Feet and 8 Feet)"); 
            document.getElementById("answer_4_Feet").value = ""; 
            document.getElementById("answer_4_Inches").value = ""; 
            document.getElementById("answer_4_Feet").focus(); 
        }
