...
function monthly_loss()
{
	...
	{
		case time < 1:
			document.getElementById("expected_1").textContent = "You will reach your goal here"; 
			document.getElementById("expected_1").style.fontWeight = "bold";
			break; 
		case time <= 2:
			document.getElementById("expected_2").textContent = "You will reach your goal here";
			document.getElementById("expected_2").style.fontWeight = "bold";
			break; 
		case time <= 3:
			document.getElementById("expected_3").textContent = "You will reach your goal here"; 
			document.getElementById("expected_3").style.fontWeight = "bold";
			break; 
		case time <= 4:
			document.getElementById("expected_4").textContent = "You will reach your goal here";
			document.getElementById("expected_4").style.fontWeight = "bold"; 
			break; 
		case time <= 5:
			document.getElementById("expected_5").textContent = "You will reach your goal here"; 
			document.getElementById("expected_5").style.fontWeight = "bold";
			break; 
		case time <= 6 : 
			document.getElementById("expected_6").textContent = "You will reach your goal here"; 
		...
		default:
			...
			if(rounded_excess > 12)
			{
				...
				document.getElementById("Expected").textContent = "You will reach your goal in " + rounded_years + " years";
				document.getElementById("Expected").style.fontWeight = "bold";
			}
			else
			{
				document.getElementById("Expected").textContent = "You will reach your goal in " + rounded_excess + " months";
				document.getElementById("Expected").style.fontWeight = "bold";
			}
			break;
	}
